    ...
    menuItems: [
      ...
      },
      {
        icon: (
          ...
          >
            <path
              d="M16 7c0-2.21-1.79-4-4-4S8 4.79 8 7c0 1.1.45 2.1 1.17 2.83L12 14l2.83-4.17C15.55 9.1 16 8.1 16 7zM6 18c0 1.1.9 2 2 2h8c1.1 0 2-.9 2-2v-1H6v1z"
              fill="currentColor"
            />
          </svg>
        ),
...
const Sidebar = ({ sidebarOpen, setSidebarOpen }: SidebarProps) => {
  ...
  return (
    <ClickOutside onClick={() => setSidebarOpen(false)}>
      <aside
        className={`absolute left-0 top-0 z-9999 flex h-screen w-72.5 flex-col overflow-y-hidden bg-gradient-to-b from-white/95 via-blue-50/90 to-white/95 dark:from-gray-900/95 dark:via-gray-800/90 dark:to-gray-900/95 backdrop-blur-xl border-r border-blue-200/30 dark:border-gray-700/30 shadow-2xl shadow-blue-500/10 dark:shadow-gray-900/20 lg:static lg:translate-x-0 sm:w-80 lg:w-72.5 ${sidebarOpen
          ? "translate-x-0 duration-500 ease-out"
          : "-translate-x-full duration-500 ease-in"
          }`}
      >
        {/* <!-- SIDEBAR HEADER --> */}
        <div className="flex items-center justify-between gap-2 px-4 py-4 sm:px-6 sm:py-6 lg:py-8 xl:py-10 border-b border-blue-200/20 dark:border-gray-700/20">
          <Link href="/" className="group">
            <div className="relative">
              ...
              <div className="relative bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm rounded-lg p-1.5 sm:p-2 border border-blue-200/50 dark:border-gray-700/50">
                <Image
                  width={176}
                  height={32}
                  ...
                  alt="Logo"
                  priority
                  className="dark:hidden transition-transform duration-300 group-hover:scale-105 w-auto h-6 sm:h-8"
                ...
                <Image
                  ...
                  alt="Logo"
                  priority
                  className="hidden dark:block transition-transform duration-300 group-hover:scale-105 w-auto h-6 sm:h-8"
                  style={{ width: "auto", height: "auto" }}
                />
              </div>
            </div>
          ...
          <button
            ...
            className="block lg:hidden p-2 rounded-lg bg-white/60 dark:bg-gray-800/60 backdrop-blur-sm border border-blue-200/50 dark:border-gray-700/50 hover:bg-white/80 dark:hover:bg-gray-800/80 transition-all duration-300 shadow-lg shadow-blue-500/10 dark:shadow-gray-900/20"
          >
            <svg
              className="fill-current text-blue-600 dark:text-blue-400 w-5 h-5 transition-transform duration-300 hover:scale-110"
              width="20"
              height="18"
              viewBox="0 0 20 18"
              fill="none"
        ...
        <div className="no-scrollbar flex flex-col overflow-y-auto duration-300 ease-linear">
          {/* <!-- Sidebar Menu --> */}
          <nav className="mt-4 sm:mt-6 px-3 sm:px-4 lg:px-6">
            {menuGroups.map((group, groupIndex) => (
              <div key={groupIndex} className="mb-6 sm:mb-8">
                <h3 className="mb-4 sm:mb-6 text-xs sm:text-sm font-bold text-blue-600 dark:text-blue-400 uppercase tracking-wider bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent">
                  {group.name}
                </h3>
